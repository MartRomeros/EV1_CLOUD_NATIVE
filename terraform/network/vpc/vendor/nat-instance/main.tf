...
# NOTA: el módulo original creaba aquí su propio aws_iam_role +
# aws_iam_role_policy_attachment + aws_iam_instance_profile para dar acceso
# SSM a la NAT instance. Se eliminó: AWS Academy no permite iam:CreateRole.
# En su lugar, aws_instance.nat_instance usa var.instance_profile_name
# (el mismo instance profile de LabRole que usan modules/ec2 y
